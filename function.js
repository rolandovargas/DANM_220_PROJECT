...
GravityPoint.RADIUS_LIMIT = 300; //era 650
...
GravityPoint.prototype = (function(o) {
    ...
    gravity:       0.5,
    isMouseOver:   false, //era false
    dragging:      false,
    destroyed:     false, //era falso
    _easeRadius:   0.9, //era 0
    _dragDistance: null,
    _collapsing:   false,
    ...
    addSpeed: function(d) {
        this._speed = this._speed.sub(d); //era add esto esta interesante
    },

    collapse: function(e) {
        this.currentRadius *= 8.75; //era 1.75
    ...
    render: function(ctx) {
        ...
        this._easeRadius = (this._easeRadius + (this.radius - this.currentRadius) * 0.07) * 0.95; //era 0.07 
    ...
    _draw: function(ctx) {
        ...
        ctx.beginPath();
        ctx.arc(this.x, this.y, this.radius * 70, 0, Math.PI * 2, false); // radius era 5
        ctx.fillStyle = grd;
        ctx.fill();
...
(function() {
    ...
    var BACKGROUND_COLOR      = 'rgba(210, 0, 560, 1)', // era 510
        PARTICLE_RADIUS       = 18, //era 3
        G_POINT_RADIUS        = 10,
    ...
    function resize(e) {
        ...
        grad.addColorStop(1, 'rgba(0, 0, 0, 8)'); //era 0.35 gradient
    }
    ...
    function addParticle(num) {
        ...
        for (i = 0; i < num; i++) {
            p = new Particle(
                Math.floor(Math.random() * screenWidth - PARTICLE_RADIUS * 6) + 1 + PARTICLE_RADIUS, //era 2
